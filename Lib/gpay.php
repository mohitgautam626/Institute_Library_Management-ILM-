          ...
          <h4 align="center" style="color:cadetblue;margin-top:10px">Select Payment Method</h4><br>
              <div class="row">
                  ...
                  <div class="col-sm-3">
                      ...
                      <p align="center" style="color:blue">GPay</p>
                  </div>
              </div>
          </div>
          </div>
              <div class="row">
                  <div class="col-md-5" style="background-color:white;border-radius:10px;margin-top:10px">
                      <h4 align="center" style="color:cadetblue;margin-top:10px">Google pay</h4><br>
                      <form style="margin-left:25px">
                          <b><font face="cursive" size=2>PHONE NO</font></b><br>
                      <input type="email" size=49 style="margin-top:5px;padding:5px;border-radius:5px">
                          <br><br>
                              <b><font face="cursive" size=2>PASSWORD</font></b><br>
                      <input type="password" size=49 style="margin-top:5px;padding:5px;border-radius:5px" placeholder="xxxxxxxxxxxx">
                          <br><br>
                          <button class="btn btn-success" type="submit"><b><font face="sans-serif" style="margin-left:10px;margin-right:10px"><A href="verification_mail.php" style="color:white;text-decoration:none">LOGIN</A></font></b></button>
                          <br><br>
